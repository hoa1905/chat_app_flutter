...
class _ProfileScreenState extends State<ProfileScreen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          currentUser.uid == uid
              ...
              IconButton(
                  onPressed: () async {
                    // navigate to settings screen with the uid as argument
  ...
  Widget buildFriendButton({
    ...
    if (currentUser.uid == userModel.uid && userModel.friendsUIDs.isNotEmpty) {
      ...
      if (currentUser.uid != userModel.uid) {
        // show cancel friend request button if the user sent us friend reqquest
        ...
        if (userModel.friendRequestsUIDs.contains(currentUser.uid)) {
          ...
          return Row(
            ...
            children: [
              buildElevatedButton(
                onPressed: () async {
                  // show unfriend dialog to ask user if he is sure to unfriend
